...
class PersonnagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personnage" do
    assert_difference('Personnage.count') do
      post personnages_url, params: { personnage: { age: @personnage.age, description: @personnage.description, nom: @personnage.nom } }
    end
  ...
  test "should update personnage" do
    patch personnage_url(@personnage), params: { personnage: { age: @personnage.age, description: @personnage.description, nom: @personnage.nom } }
