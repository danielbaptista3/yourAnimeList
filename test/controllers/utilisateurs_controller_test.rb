...
class UtilisateursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utilisateur" do
    assert_difference('Utilisateur.count') do
      post utilisateurs_url, params: { utilisateur: { identifiant: @utilisateur.identifiant, mail: @utilisateur.mail, naissance: @utilisateur.naissance, nom: @utilisateur.nom, permission: @utilisateur.permission } }
    end
  ...
  test "should update utilisateur" do
    patch utilisateur_url(@utilisateur), params: { utilisateur: { identifiant: @utilisateur.identifiant, mail: @utilisateur.mail, naissance: @utilisateur.naissance, nom: @utilisateur.nom, permission: @utilisateur.permission } }
